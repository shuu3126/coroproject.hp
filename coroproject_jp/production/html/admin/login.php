...
if ($adminRoot === '') {
    ...
    $adminRoot = $adminPos !== false ? rtrim(substr($requestPath, 0, $adminPos + 6), '/') : '/production/html/admin';
}
?>
<!doctype html>
<html lang="ja">
<head>
  ...
  <title>ログイン | CORO PROJECT 管理画面</title>
  <link rel="stylesheet" href="<?= h($adminRoot) ?>/assets/css/admin.css?v=20260427-6">
</head>
