...
<main class="page-container">
  ...
  <section class="card-grid three mt-24">
    ...
    <a class="card menu-card" href="<?= h($baseUrl) ?>/accounting/invoice_edit.php?mode=manual&division=production"><h3>Production スポット請求</h3><p>グッズ制作費、送料、立替金などをタレント宛に請求します。</p></a>
  </section>
