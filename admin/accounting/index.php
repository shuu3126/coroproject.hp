...
<main class="page-container">
  ...
  <section class="card-grid three mt-24">
    ...
    <a class="card menu-card" href="<?= h($baseUrl) ?>/accounting/invoice_edit.php?mode=manual&division=production"><h3>請求書を作成</h3><p>Production・Business・Creative いずれも作成できます。</p></a>
  </section>
