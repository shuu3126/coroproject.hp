...
<main class="page-container">
  ...
  <section class="card-grid four" style="grid-template-columns:repeat(4,1fr);margin-top:12px;">
    ...
    <a class="card stat-card" href="<?= h($baseUrl) ?>/inquiries/messages.php">
  ...
  <section class="card-grid three mt-24">
    <div class="card" style="padding:20px;">
      ...
      <div style="display:flex;flex-direction:column;gap:6px;">
        <a class="ghost-btn" style="text-align:left;" href="<?= h($baseUrl) ?>/production/talents.php">タレント管理（<?= h((string)$talentCount) ?>名）</a>
        <a class="ghost-btn" style="text-align:left;" href="<?= h($baseUrl) ?>/content/news.php">お知らせ管理</a>
    ...
    <div class="card" style="padding:20px;">
      ...
      <div style="display:flex;flex-direction:column;gap:6px;">
        ...
        <a class="ghost-btn" style="text-align:left;" href="<?= h($baseUrl) ?>/crm/clients.php">クライアント管理</a>
      </div>
    </div>
    <div class="card" style="padding:20px;">
  ...
  <section class="card table-card mt-24">
    <div style="display:flex;justify-content:space-between;align-items:center;padding:14px 20px;border-bottom:1px solid var(--line);">
      ...
      <a class="ghost-btn" style="font-size:0.8em;padding:4px 10px;" href="<?= h($baseUrl) ?>/system/logs.php">すべて見る</a>
    </div>
