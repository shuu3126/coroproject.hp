...
<main class="page-container">
  <section class="page-header-block with-actions">
    ...
    <a class="primary-btn" href="<?= h($baseUrl) ?>/client_edit.php">新規追加</a>
  </section>
  ...
  <form method="get" class="card form-card form-grid two">
    ...
    <div class="form-grid two" style="gap:10px;">
      ...
      <div class="actions-inline" style="align-self:end;">
        ...
        <a class="ghost-btn" href="<?= h($baseUrl) ?>/clients.php">リセット</a>
      </div>
    </div>
  </form>
        ...
        <?php foreach ($rows as $r): ?>
          <tr>
            ...
            <td class="actions-inline">
              <a class="ghost-btn" href="<?= h($baseUrl) ?>/client_edit.php?id=<?= urlencode($r['id']) ?>">編集</a>
