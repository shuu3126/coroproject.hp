...
<main class="page-container">
  <section class="card-grid two">
    ...
    <a class="card stat-card" href="<?= h($baseUrl) ?>/crm/clients.php">
  ...
  <section class="card-grid three mt-24">
    ...
    <a class="card menu-card" href="<?= h($baseUrl) ?>/crm/clients.php"><h3>クライアント管理</h3><p>企業・個人・団体の連絡先と取引履歴を管理します。</p></a>
  </section>
