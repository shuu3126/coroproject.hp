...
<main class="page-container">
  <form method="get" class="card form-card form-grid two">
    ...
    <div class="actions-inline" style="align-self:end;"><button class="ghost-btn" type="submit">検索する</button><a class="ghost-btn" href="<?= h($baseUrl) ?>/system/logs.php">条件をリセット</a></div>
  </form>
  ...
  <?php if (!$rows): ?><tr><td colspan="5" class="empty-state">まだ操作ログがありません。</td></tr><?php endif; ?>
