...
CREATE TABLE IF NOT EXISTS cre_creators (
  ...
  discord_name VARCHAR(191) NULL,
  postal_code VARCHAR(20) NULL,
  address TEXT NULL,
  bank_info TEXT NULL,
  invoice_registration_no VARCHAR(100) NULL,
  withholding_type VARCHAR(30) NOT NULL DEFAULT 'individual',
  availability_status VARCHAR(30) NOT NULL DEFAULT 'available',
  available_note TEXT NULL,
