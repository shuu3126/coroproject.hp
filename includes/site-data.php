...
$newsItems = [
    [
        ...
        'body' => [
            'CORO PROJECTの総合ポータルサイトを公開いたしました。Production、Business Matching、Creative Supportの3事業をわかりやすく案内し、それぞれの相談窓口へスムーズにつながる導線を整えています。',
    ...
    [
        ...
        'body' => [
            ...
            '案件単位のご相談だけでなく、継続的に連携できる制作パートナーの募集・ヒアリングも行っています。Creative Supportの詳細は今後順次公開予定です。'
        ]
    ],
    [
        'id' => '2026-03',
