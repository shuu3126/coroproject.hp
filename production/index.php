...
try {
    ...
    foreach ($topTalents as &$t) {
        $t['avatar_for_top'] = production_public_url($t['avatar'] ?? '');
    }
    unset($t);
...
<head>
  ...
  <title>CORO PROJECT Production | VTuber事務所・所属タレント情報</title>
  <meta name="description" content="CORO PROJECT Productionは、所属タレントの活動支援・マネジメントを行うVTuber事務所です。所属メンバー情報や最新ニュース、オーディション情報を掲載しています。">
  ...
  <meta property="og:title" content="CORO PROJECT Production | VTuber事務所・所属タレント情報">
  <meta property="og:description" content="所属タレントの活動支援・マネジメントを行うCORO PROJECT Productionの公式ページ。最新ニュースやオーディション情報も掲載しています。">
  ...
  <meta name="twitter:title" content="CORO PROJECT Production | VTuber事務所・所属タレント情報">
  <meta name="twitter:description" content="所属タレントの活動支援・マネジメントを行うCORO PROJECT Productionの公式ページです。">
  ...
  <script type="application/ld+json">
    {
      ...
      "@graph": [
        ...
        },
        {
          "@type": "Service",
          "name": "CORO PROJECT Production",
          "serviceType": "VTuber事務所・タレントマネジメント",
          "provider": {
            "@type": "Organization",
            "name": "CORO PROJECT Production"
          },
          "areaServed": "JP",
          "url": "https://coroproject.jp/production/",
          "description": "所属タレントの活動支援、マネジメント、プロモーションを行うVTuber事務所。"
        },
        {
          "@type": "WebPage",
          "name": "CORO PROJECT Production | VTuber事務所・所属タレント情報",
          "url": "https://coroproject.jp/production/",
          "description": "所属タレントの活動支援・マネジメントを行うCORO PROJECT Productionの公式ページ。最新ニュースやオーディション情報も掲載しています。"
        }
      ]
    }
  </script>
...
<body class="home is-loading">
        ...
        <div class="container cta-audition">
          <div class="cta-audition-copy">
            ...
            <div class="cta-actions">
              ...
              <a class="btn btn-outline" href="../contact.php">まずは相談してみる</a>
            </div>
    ...
    <footer class="site-footer">
      <div class="container footer-inner">
        ...
        <div class="footer-col">
          <h4>Social</h4>
          <ul>
            <?php coro_public_render_social_list(); ?>
          </ul>
        </div>
      </div>
  ...
  <!-- ===== Scripts ===== -->
  <script src="../assets/js/social-links.js?v=20260429-1" data-social-endpoint="html/api/site-links.php"></script>
  <script>
    // 年号
