...
foreach ($talents as &$t) {
    $t['avatar_for_list'] = production_public_url($t['avatar'] ?? '');
}
unset($t);
?>
<!doctype html>
...
<body>
      ...
      <div class="container footer-inner">
        <div class="footer-col">
          ...
          <div class="footer-actions">
            <a class="btn btn-primary" href="../../contact.php">問い合わせ</a>
          </div>
        </div>
  ...
  <script src="../../assets/js/social-links.js?v=20260429-1" data-social-endpoint="api/site-links.php"></script>
  <script>
    // 年号
