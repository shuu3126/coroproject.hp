...
$siteTitle = 'About | COROCONNECT | CORO PROJECT';
render_header('about', $siteTitle, [
  'page_name' => 'About | COROCONNECT | CORO PROJECT',
  'canonical' => 'https://coroproject.jp/business/about.php',
  'description' => 'COROCONNECTの考え方と支援方針。企業がVTuber施策を安心して進めるための相談窓口として、整理から実行支援までの全体像を紹介します。'
]);
?>
  ...
  <div class="container hero-inner hero-inner--page">
    ...
    <aside class="hero-panel reveal delay-1">
      <div class="panel-frame">
        <div class="panel-label">ABOUT COROCONNECT</div>
...
<section class="content-section">
  <div class="container section-grid">
    <div class="section-copy reveal">
      ...
      <p class="section-text">COROCONNECTは、企業・ブランド・イベントとVTuberをつなぎ、起用の相談受付から企画整理、進行実務までを支える事業部です。施策を成立させるだけでなく、相談しやすく進めやすい状態まで整えることを大切にしています。</p>
